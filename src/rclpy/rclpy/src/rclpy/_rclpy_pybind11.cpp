...
PYBIND11_MODULE(_rclpy_pybind11, m) {
  ...
  m.def(
    "rclpy_trace_publish", rclpy::trace_publish,
    "Trace event for publishing a message."
  );

  m.def(
    "rclpy_trace_take", rclpy::trace_take,
    "Trace event for taking a message."
  );
  
  m.def(
    "rclpy_trace_callback_start", rclpy::trace_callback_start,
    "Trace event for starting a callback."
  );

  m.def(
    "rclpy_trace_callback_end", rclpy::trace_callback_end,
    "Trace event for ending a callback."
  );
