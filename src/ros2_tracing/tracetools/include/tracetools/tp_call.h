...
TRACEPOINT_EVENT(
  ...
  TP_ARGS(
    const void *, message_arg,
    const int64_t, source_timestamp_arg,
    const int64_t, received_timestamp_arg
  ),
  TP_FIELDS(
    ctf_integer_hex(const void *, message, message_arg)
    ctf_integer(const int64_t, source_timestamp, source_timestamp_arg)
    ctf_integer(const int64_t, received_timestamp, received_timestamp_arg)
  )
)
...
TRACEPOINT_EVENT(
  ...
  rclpy_publish,
  TP_ARGS(
    const char *, node_name_arg, const uint64_t, message_arg, const char *, topic_name_arg
  ),
  TP_FIELDS(
    ctf_string(node_name, node_name_arg)
    ctf_string(topic_name, topic_name_arg)
...
TRACEPOINT_EVENT(
  ...
  TP_FIELDS(
    ctf_string(node_name, node_name_arg)
    ctf_string(topic_name, topic_name_arg)  // ctf_string(value_name, value)
    ctf_integer_hex(const void *, message, message_arg)
    ctf_integer(const int64_t, source_timestamp, source_timestamp_arg)
    ctf_integer(const int64_t, received_timestamp, received_timestamp_arg)
  )
...
TRACEPOINT_EVENT(
  ...
  TP_FIELDS(
    ctf_string(node_name, node_name_arg)
    ctf_integer_hex(uint64_t, callback, callback_arg)
  )
)
